...
func InitDB() {
	...
	// запускаем сихнронизацию всех прав в БД с теми, что в коде. Автоматически выдём все права суперадмину
	synchronizePermissions(DB)
	...
	// к удалённым полям
	err = DB.AutoMigrate(&User{}, &Secret{}, &AuditLog{}, &PasswordAccessRequest{}, &SharedSecret{}, &Role{}, &Permission{}, &RolePermission{})
	if err != nil {
